...
class Command(BaseCommand):
    ...
    def _product_comments(self, productId, food):
        ...
        source = self._product_content('https://www.zoopet.com.tr/api/product/GetComments?productId=' + str(productId))
        if source:
            ...
            c = FoodComment.objects.filter(food_id=food.id, petshop_id=7).aggregate(max_date=Max('created'))
